...
class Hk_Eavmgmt_Block_Adminhtml_Attribute_Exportoption extends Mage_Eav_Block_Adminhtml_Attribute_Grid_Abstract
{
     protected function _prepareColumns()
    {
        $this->addColumn('index', array(
            ...
            'index'  => 'entity_id',
            // 'renderer'=> 'Hk_Eavmgmt_Block_Adminhtml_Attribute_Csv_Number'
        ));
