 ...
 * 
 */
class Ccc_Sample_Adminhtml_AttributeController extends Mage_Adminhtml_Controller_Action
{

	public function indexAction()
	{
		$this->_title($this->__('Sample'))
             ->_title($this->__('Manage Attribute'));

        $this->loadLayout();
        $this->_addContent($this->getLayout()->createBlock('sample/adminhtml_attribute', 'sample'));
        $this->renderLayout();
	}
